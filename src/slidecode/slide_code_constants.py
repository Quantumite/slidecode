...
SLIDECODE_ARCH_64 = """If you are creating a 64-bit payload, use this flag."""
...
SLIDECODE64_OFFSET_FOURTH_KEY = -1*(8+SLIDECODE_SIZE_FINAL_CALL)
SLIDECODE64_OFFSET_THIRD_KEY = -1*(16+SLIDECODE_SIZE_FINAL_CALL)
SLIDECODE64_OFFSET_SECOND_KEY = -1*(24+SLIDECODE_SIZE_FINAL_CALL)
SLIDECODE64_OFFSET_FIRST_KEY = -1*(32+SLIDECODE_SIZE_FINAL_CALL)
